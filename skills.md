...
This file contains the configuration, installation references, and instructions for the leading Design, UI/UX, Frontend, and Animation skills.
...
**Guidelines Source:** [vercel-labs/web-interface-guidelines](https://raw.githubusercontent.com/vercel-labs/web-interface-guidelines/main/command.md)
...
**Description:** AI-driven color matching skill providing custom palettes tailored to specific contexts.
